...
const repPwdValidator_directive_1 = require("./subscribe/repPwdValidator.directive");
...
AppModule = __decorate([
    core_1.NgModule({
        imports: [http_1.HttpModule, router_1.RouterModule, platform_browser_1.BrowserModule, account_module_1.AccountModule, login_module_1.LoginModule, user_module_1.UserModule, utils_module_1.UtilsModule, app_routes_1.RoutesModule, forms_1.FormsModule],
        declarations: [app_component_1.AppComponent, header_1.Header, subscribe_component_1.SubscribeComponent, repPwdValidator_directive_1.RepPwdValidator],
